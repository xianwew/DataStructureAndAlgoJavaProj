...
* @return initiallize hashtable size
*/
...
* @return Calculate the value after the first hash operation has been modded.
*/
...
* @param containkey Whether the existing key is already in the hashtable.
* @throws exception from memory menager serialization
*/
...
* @param success if you successfully delete the keys
*/
