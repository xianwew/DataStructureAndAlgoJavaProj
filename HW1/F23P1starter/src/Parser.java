...
public class Parser {
    ...
    public Object[] initializeComponents(String[] args) {
        if (args != null) {
            ...
            if ((i & i - 1) != 0 || i <= 0) {
                System.out.println(
                        "Error in creating memory pool! " + "The size must be the power " + "of 2 and greater than 0!");
...
//	        System.out.println(test.length);
    ...
    /**
     * The most important function of the parser class, it read, process the files
     * and pass it to world database for further processing
     * 
